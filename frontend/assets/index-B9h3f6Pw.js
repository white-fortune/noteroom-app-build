            ...
            `,children:[e.jsxs("div",{className:`top-bar\r
                ...
                `,children:[e.jsx("div",{className:`display-image-holder\r
                    ...
                    `,children:e.jsx("div",{className:`display-image
                            ...
                            overflow-hidden
                        `,children:e.jsx("img",{src:s.profileImageUrl,className:"w-full h-full object-cover",alt:"Display Image"})})}),e.jsx("div",{className:"block xl:hidden",children:e.jsx(m,{user:s,className:"flex xl:hidden mt-3 gap-2"})})]}),e.jsxs("div",{className:`entity-headline\r
                    w-[95%] self-center\r
                    flex flex-col gap-5\r
                    mt-3\r
                ...
                `,children:[e.jsxs("div",{className:"profile-text-metadata gap-2 flex flex-col w-full font-sans",children:[e.jsx("div",{className:"top-section block xl:flex justify-between items-center",children:e.jsx("span",{className:"font-bold text-lg",children:s.name})}),e.jsx("span",{className:"about text-sm",children:s.bio})]}),e.jsxs("div",{className:`bottom-left\r
                        ...
                        text-[12px]\r
                        desktop:text-base\r
                    `,children:[e.jsxs("div",{className:"flex gap-3 desktop:gap-5",children:[e.jsxs("span",{className:"following flex gap-0.5",children:[e.jsx("span",{className:"font-bold",children:"46"}),"Following"]}),e.jsxs("span",{className:"followers flex gap-0.5",children:[e.jsx("span",{className:"font-bold",children:"46k"}),"Followers"]})]}),e.jsx(m,{user:s,className:"hidden xl:flex gap-2"})]})]})]})]})}function k({user:s}){const[n,a]=c.useState(null);if(s.posts){const l=s.posts;return e.jsx("div",{className:"posts flex flex-col w-full",children:s.posts.map((r,t)=>e.jsxs(e.Fragment,{children:[e.jsx(y,{post:r,threeDotsMenu:[n,a],postCreationDate:!0}),t===l.length-1&&e.jsx("div",{className:"mb-10"}),t!==l.length-1&&e.jsx(b,{extendedClass:"my-5"})]}))})}}function Q(){const{username:s}=h(),{navElements:[,n]}=u(),a=["Posts","About","Communities","Questions"],[l,r]=c.useState("Posts"),{data:t}=N(g,{username:s},{enabled:!!s,queryKey:["getuser",{username:s}]});if(c.useEffect(()=>(n({desktop:{show:!0},mobile:{left:e.jsxs("div",{className:"flex items-center gap-2 xl:hidden",children:[e.jsx(x,{}),e.jsx("div",{className:"action-title h-12 overflow-hidden flex flex-row justify-start items-center",children:e.jsx("span",{className:"text-lg font-['Space_Grotesk']",children:"Profile"})})]})}}),()=>n({})),[]),!t||!t.user)return null;const d=t.user;return e.jsxs("div",{className:`user-profile left-panel\r
            w-full\r
            flex flex-col gap-5\r
            mt-5\r
        `,children:[e.jsxs("div",{className:"back flex flex-col gap-5",children:[e.jsxs("div",{className:"back hidden xl:flex items-center gap-3",children:[e.jsx(x,{}),e.jsx("span",{className:"font-space",children:"Profile"})]}),e.jsx(P,{user:d})]}),e.jsx(j,{tabItems:a,activeTab:[l,r]}),e.jsx("div",{className:"tab-contents flex w-full mb-10",children:l==="Posts"&&e.jsx(k,{user:d})})]})}export{Q as default};
