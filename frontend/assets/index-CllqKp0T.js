import{r as a,u as p,j as e,a as d,b as x,c as f,d as m}from"./index-B1xnd1eW.js";import{D as u,P as h,u as j}from"./Post-D593Fgh4.js";import{u as g,G as v,a as y}from"./graphql.types--8JdJqgd.js";import{L as w}from"./LogoLoading-DuPTzGnq.js";import{u as N}from"./NavigationPanelContext-cQS5ck-W.js";import{i as D}from"./iconsLoader-nPPCSOMO.js";import{S as E,P}from"./PostContainer-DsVFLpd4.js";import"./Backdrop-B6vlnGm6.js";import"./proxy-DEv8yYt6.js";import"./index-CWkzeKqT.js";import"./NoteRoomLogoMark_logomark-fullcolor-rgb-512_512px-DiCDYmyP.js";import"./Button-Bf0_FUze.js";import"./react-BaH3va9d.js";import"./BackButton-Ccyn4OTF.js";function b(){const[t,s]=a.useState(null),o=p(),{data:r,isLoading:i}=g(v,{},{queryKey:["posts",{page:1}],select:n=>n.posts?(n.posts.forEach(l=>{o.setQueryData(["post",{postID:l.postID}],{post:l})}),{postIDs:n.posts.map(l=>l.postID)}):{postIDs:[]}});if(i)return e.jsx(w,{});if(r&&r.postIDs){const n=r.postIDs;return e.jsx("div",{className:`feed-section\r
		...
		`,children:[e.jsx("div",{className:"profile-pic h-full xl:w-[10%]",children:e.jsx("div",{className:"flex w-full h-full items-center justify-center",children:e.jsx("div",{className:"profile-pic h-10 w-10 overflow-hidden rounded-[50%]",children:s&&e.jsx("img",{src:s.profileImageUrl,className:"w-full h-full object-cover",alt:"user"})})})}),e.jsx("div",{className:"intro-text flex items-center justify-start h-full w-full xl:w-[90%]",children:e.jsx("span",{className:"font-['Space_Grotesk'] text-[16px] xl:text-[15px] desktop:text-[20px] text-[rgba(0,0,0,0.7)]",children:t||"What are you working on?"})}),e.jsx("div",{className:"tools-section flex justify-center items-center xl:hidden ",children:e.jsx("div",{className:"plus-icon rounded-full border border-[#1E1E1E] flex justify-center items-center",children:e.jsx(D.plus,{width:"30",height:"30",stroke:"#1E1E1E"})})})]})}function S({introText:t}){const{openOverlay:s}=d(),{width:o}=j(),r=x();function i(){o>1024?s(e.jsx(P,{})):r("/post/create")}return e.jsxs("div",{className:"flex flex-col w-full items-center",children:[e.jsxs("div",{className:`post-section\r
			...
			`,onClick:i,children:[e.jsx(C,{introText:t}),e.jsx(E,{className:`\r
				...
				`})]}),e.jsx(u,{extendedClass:"my-7"})]})}function R(){const{navElements:[,t]}=N(),{sideBar:[,s]}=m();return a.useEffect(()=>(t({desktop:{show:!0}}),()=>t({})),[]),a.useEffect(()=>()=>s(!1),[s]),e.jsxs("div",{className:"flex w-full flex-col mt-5",children:[e.jsx(S,{}),e.jsx(b,{})]})}export{R as default};
