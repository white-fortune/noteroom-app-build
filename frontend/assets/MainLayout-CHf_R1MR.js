import{B as w,A as N,r as o,b as h,j as e,R as j,d as g,c as y,L as P,a as m,O as k}from"./index-B1xnd1eW.js";import{u as E,H as C,S,L as R,T as _,P as L,a as B,b as I}from"./PrimaryTopbarContext-DcYMq522.js";import{i as r}from"./iconsLoader-nPPCSOMO.js";import{N as F}from"./NoteRoom_logo-fullcolor-rgb-2-1000_1000px-DxGY_Wqj.js";import{B as b}from"./Button-Bf0_FUze.js";import{N as T}from"./NoteRoomLogoMark_logomark-fullcolor-rgb-512_512px-DiCDYmyP.js";import{u as $,N as A}from"./NavigationPanelContext-cQS5ck-W.js";import{u as D,R as z}from"./RightPanelContext-D0wiS8l7.js";import{d as f}from"./dexieDB-BbeobwOU.js";import{A as G}from"./index-CWkzeKqT.js";import{m as p}from"./proxy-DEv8yYt6.js";import{B as M}from"./Backdrop-B6vlnGm6.js";var O=w();function v({icon:s}){return j.cloneElement(s,{className:"h-[24px] w-[24px]"})}function a({label:s,icon:t,onClick:n,active:l=!1}){return e.jsxs("div",{className:`item
			w-[90%]
		...
		`,children:[e.jsxs("div",{className:"desktop hidden xl:flex items-center gap-6 desktop:gap-8 w-full h-full",children:[s.desktop?.left||e.jsx(J,{}),s.desktop?.right||e.jsx(u,{})]}),e.jsxs("div",{className:"mobile flex w-full h-full xl:hidden justify-between items-center",children:[s.mobile?.left||e.jsx(V,{}),s.mobile?.right||e.jsx(u,{})]})]})}function d({name:s,label:t,isActive:n,...l}){return e.jsx("button",{className:`${s}
			...
			hover:bg-[#EFEFEF]`,onClick:()=>t(`/post/${s.postID}/${s.titleSlug}`),children:[e.jsxs("div",{className:"left-side flex flex-col gap-2 w-full",children:[e.jsx("div",{className:"post-header w-full flex gap-2 items-center",children:e.jsx("span",{className:"hover:underline text-[rgba(0,0,0,0.6)] font-semibold",children:s.author.name})}),e.jsx("div",{className:"post-content flex flex-col gap-1 w-full",children:e.jsx("span",{className:"text-justify hyphens-auto font-semibold",children:s.title.length>50?`${s.title.slice(0,50)}...`:s.title})}),e.jsxs("div",{className:"post-footer w-full flex justify-between",children:[e.jsxs("span",{children:[s.reactCount||0," Likes"]}),e.jsxs("span",{children:[s.replyCount||0," Comments"]})]})]}),e.jsx("div",{className:"right-side flex flex-col gap-2",children:e.jsx("div",{className:"post-thumbnail overflow-hidden w-20 h-20 rounded-[10px]",children:s.thumbnail&&e.jsx("img",{src:s.thumbnail,alt:"Post Image",className:"w-full h-full object-cover"})})})]})}function X(){const[s,t]=o.useState([]);async function n(){await f.recentPosts.clear(),t([])}return o.useEffect(()=>{f.recentPosts.toArray().then(l=>t(l)).catch(l=>console.error(l))},[]),e.jsxs("div",{className:"recent-posts flex flex-col items-end gap-2",children:[s.length>0&&e.jsx("div",{className:"clear",children:e.jsx("span",{className:"text-sm text-primary-blue-dark-lm cursor-pointer",onClick:n,children:"Clear"})}),e.jsx("div",{className:"posts w-full flex flex-col gap-4 text-[12px] mb-10",children:s.map(l=>e.jsx(W,{post:l},l.postID))})]})}function Y(){const[s,t]=o.useState("posts");return e.jsxs("div",{className:"container w-[90%] h-full font-inter",children:[e.jsx("div",{className:"header h-[5vh] mt-[3vh] flex items-center w-full",children:e.jsx("span",{className:"font-semibold text-sm text-[rgba(0,0,0,0.5)]",children:"Recently seen"})}),e.jsxs("div",{className:"right-panel-container flex flex-col items-center h-[90vh] w-[90%] desktop:w-[80%]",children:[e.jsx(Q,{activeRecentSection:[s,t]}),e.jsx("div",{className:"overflow-y-auto w-full left-panel",children:s==="posts"&&e.jsx(X,{})})]})]})}function Z(){const{rightPanelElements:[s]}=D();return e.jsx("div",{className:"right-panel bg-(--primary-secondary-rightpanel-clr) hidden xl:flex rounded-[0_10px_0_0]",children:s.container||e.jsx(Y,{})})}function ee(){const{popup:[s,t]}=m();return e.jsx("div",{className:`popup-container\r
			w-screen h-auto\r
        ...
        `,children:[e.jsx("span",{className:"font-inter ml-1 text-sm",children:s.message}),e.jsx("div",{className:"close-button h-[20%] desktop:h-[22%] flex justify-center items-center",onClick:()=>t({show:!1,message:""}),children:e.jsx(r.cross,{width:"30",height:"30",className:"rounded-[50%] bg-gray-200 hover:bg-gray-300 active:bg-gray-300 cursor-pointer",viewBox:"0 0 24 24"})})]})}function te(){const{activeOverlay:s,popup:[t],toast:[n]}=m(),l=.2;return O.createPortal(e.jsxs(G,{mode:"wait",children:[s&&e.jsx(p.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:l},className:`floating-elements
							fixed inset-0 z-50
							flex justify-center items-center
							bg-black/50
						`,children:e.jsx(p.div,{initial:{opacity:0,y:"10%"},animate:{opacity:1,y:"0%"},exit:{opacity:0,y:"10%"},transition:{duration:l},children:s})}),t.show&&e.jsx("div",{className:`floating-elements\r
		...
		`,children:s})}function ce({children:s}){return e.jsx("div",{className:`secondary-middle-section left-panel\r
			...
			lg:w-[50%]\r
			xl:w-full\r
		`,children:s})}function Ne(){const{sideBar:[s,t]}=g();return e.jsxs(le,{children:[e.jsx(ne,{children:e.jsxs(R,{children:[e.jsx(q,{open:s}),s&&e.jsx(M,{zIndex:30,onClick:()=>t(!1)}),e.jsxs(_,{children:[e.jsx(ae,{}),e.jsx(re,{children:e.jsxs(L,{children:[e.jsx(oe,{}),e.jsxs(z,{children:[e.jsx(A,{children:e.jsxs(ie,{children:[e.jsx(K,{}),e.jsx(ce,{children:e.jsx(k,{})})]})}),e.jsx(Z,{})]})]})})]})]})}),e.jsx(te,{})]})}export{Ne as default};
