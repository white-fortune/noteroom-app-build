import{r as a,u as f,j as e,a as p,b as d,c as x,d as m}from"./index-BtXRzL6T.js";import{u as c,G as h,a as j}from"./graphql.types-CCRoWeID.js";import{P as g}from"./Post-BoeIfVIs.js";import{L as v}from"./LogoLoading-DUiln7A-.js";import{u as w}from"./BackButton-JX-ATXzj.js";import{i as y}from"./iconsLoader-iz3GJFGa.js";import{S as N,P}from"./PostContainer-DYKCbSLW.js";import{u as b}from"./useWindowSize-M_PaXH4g.js";import"./proxy-C2WUHU84.js";import"./index-DDVaG5Ai.js";import"./NoteRoomLogoMark_logomark-fullcolor-rgb-512_512px-DiCDYmyP.js";import"./Button-n5Kdp1fq.js";import"./react-CGko_yy-.js";function D(){const[s,t]=a.useState(null),n=f(),{data:r,isLoading:i}=c(h,{},{queryKey:["posts",{page:1}],select:l=>l.posts?(l.posts.forEach(o=>{n.setQueryData(["post",{postID:o.postID}],{post:o})}),{postIDs:l.posts.map(o=>o.postID)}):{postIDs:[]}});if(i)return e.jsx(v,{});if(r&&r.postIDs){const l=r.postIDs;return e.jsx("div",{className:"feed-section flex flex-col w-full items-center gap-8",children:l.map((o,u)=>e.jsxs("div",{className:"w-full flex flex-col items-center gap-8",children:[e.jsx(E,{postID:o,threeDotsMenu:[s,t]}),u===l.length-1&&e.jsx("div",{className:"mb-10"})]},o))})}}function E({postID:s,threeDotsMenu:t}){const{data:n}=c(j,{postID:s},{queryKey:["post",{postID:s}]}),r=n&&n.post;return r?e.jsx(g,{post:r,threeDotsMenu:t,postCreationDate:!0,trimmedDescription:!0}):null}function I({introText:s}){const{user:[t]}=x();return e.jsxs("div",{className:`intro\r
			w-full h-full\r
