import{j as t}from"./index-vZtEAzgS.js";function c({tabItems:e,activeTab:[i,n]}){return t.jsx("div",{className:"tabs flex w-full justify-start gap-2.5",children:e.map(r=>{const o=r===i;return t.jsx("button",{className:`
